// Originally from https://github.com/grafana/grafana/blob/c58542348d/pkg/tsdb/prometheus/client/client.go
...
func (c *Client) QueryRange(ctx context.Context, q *Query, headers http.Header) (*http.Response, error) {
	tr := q.TimeRange()
...
func (c *Client) QueryInstant(ctx context.Context, q *Query, headers http.Header) (*http.Response, error) {
...
func (c *Client) QueryExemplars(ctx context.Context, q *Query, headers http.Header) (*http.Response, error) {
	tr := q.TimeRange()
